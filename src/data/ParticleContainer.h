...
public:
    ...
    void forAllDistinctCellNeighbours(F fun) {
        ...
        std::array<a, numCases> offsets{a{1,0,0}, a{0,1,0}, a{0,0,1},
                                        a{1,1,0}, a{1,-1,0},
        ...
        std::array<b, numCases> upperBounds{b{gD[0]-1, gD[1], gD[2]}, b{gD[0], gD[1]-1, gD[2]}, b{gD[0], gD[1], gD[2]-1},
        ...
        std::array<b, numCases> lowerBounds{b{0,0,0}, b{0,0,0}, b{0,0,0},
                                            b{0,0,0}, b{0,1,0},
