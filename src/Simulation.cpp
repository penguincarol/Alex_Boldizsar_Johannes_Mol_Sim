...
namespace sim{
    ...
    /**
    *   calculates the force acting on particle1
    */
    Eigen::Vector3d FLennardJones2Particles(Particle &p1, Particle &p2){
    ...
    void calculateFLennardJones() {
        ...
        particleContainer.addUpForces(FLennardJones2Particles);
    }
