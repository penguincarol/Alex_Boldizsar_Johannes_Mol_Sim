...
namespace sim::physics::force {
    ...
    using fpair_fun_t = void(*)(Kokkos::View<double*> &force,
    ...
    using fpair_fun_alt_t = void(*)(Kokkos::View<double*> &force,
                                    Kokkos::View<double*> &x,
                                    Kokkos::View<double*> &eps,
                                    Kokkos::View<double*> &sig,
                                    Kokkos::View<double*> &m,
    ...
    using fpair_fun_ret_t = std::array<double,3>(*)(Kokkos::View<double*> &force,
                                                    Kokkos::View<double*> &x,
                                                    Kokkos::View<double*> &eps,
                                                    Kokkos::View<double*> &sig,
                                                    Kokkos::View<double*> &m,
